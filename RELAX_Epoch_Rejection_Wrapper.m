...
RELAX_epoching_cfg.PercentWorstEpochsForMuscle=0.50; % Maximum proportion of muscle epochs to remove (if more epochs than this are affected, only the worst effected up to this proportion will be removed)
...
for Subjects=1:5%numel(RELAX_epoching_cfg.files)
...
hold on; plot(MedianvoltageshiftwithinepochLogged); legend('LowerBound', 'UpperBound');
