...
% GUI layout
geometry = {[0.55 1 0.2 0.6 1.5 0.2 0.75 1.2] ... % setting directory
            1 ...
            [5 .8 .5 2 0.5] ... % bandpass filter settings
            1 ...
            [1.4 0.2 0.2 1.4 0.2 0.2 1.3 0.2] ... % electrode rejection settings
            1 ...
            [2.1 0.7 0.3 1.3 0.3 0.8 0.3 0.7 0.3] ... % extreme period rejection settings
            1 ...
            [0.9 0.2 1.3 0.2 1.3 0.2 1]... % extreme period rejection settings MAD blinks and drift
            1 ...
            [0.6 0.2 0.6 0.4 0.4 0.6 0.6 0.4 0.6 0.9 1] ... %Wiener filter settings wICA settings and Blink probability options
            1 ...
            [0.7 1 0.95 0.9 1 0.9]... % eye movement affected electrodes
            1 ...
            [2.5 0.3 0.3 1.9 0.3 2]... % muscle marking for MWF
            1 ...
            [1.7 0.2 0.05 2.2 0.2]... % drift marking for MWF
            1 ...
            [2.2 0.3 1 3 0.5]... % horizontal eye movement marking for MWF
            1 ...
            [0.8 0.7 0.8 1.1 1.9 1.1 1.1 1.1]... % computing metrics? saving intermediate files?
            };
            
% GUI settings with defaults:        
uilist = {{'style', 'text', 'string', 'Folder with data:','fontweight','bold','fontsize', 10} ...
          ...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Max proportion marked as muscle for MWF cleaning:','fontsize', 10} ...
          ...
          {'style', 'text', 'string', '','fontsize', 10}...
          {'style', 'text', 'string', 'File numbers to process this session (from start file # to finish file # and files in between):','fontsize', 10} ...
          {'style', 'edit', 'string', ['1', '  ', '2'],'fontsize', 10}...
          {}...
          {'style', 'text', 'string', 'Compute Metrics?','fontweight','bold','fontsize', 10} ... 
          {'Style', 'checkbox', 'string' 'Raw metrics' 'value' RELAX_cfg.computerawmetrics 'tag' 'raw' ,'fontsize', 10} ... % Input 1
          {'Style', 'checkbox', 'string' 'Cleaned metrics' 'value' RELAX_cfg.computecleanedmetrics 'tag' 'clean' ,'fontsize', 10} ... % Input 2
...
result = inputgui('geometry', geometry, 'geomvert', [1 .4 1 .4 1 0.4 1 0.4 1 0.4 1 0.4 1 0.4 1 0.4 1 0.4 1 0.4 1],  'uilist', uilist, 'title', 'RELAX Parameter Setting',  'helpcom', 'pophelp(''pop_RELAX'')');
