...
% GUI layout
geometry = {[0.58 1.5 0.2 1.78] ... % setting directory
            1 ...
            [0.5 1 2] ... % electrodes to exclude
            1 ...
            [6 .8 2 2.6 0.5 1] ... % bandpass filter settings
            1 ...
            ...
            1 ...
            [1.2 0.3 0.4 1.6 0.3 1.8]... % computing metrics?
            };
...
uilist = {{'style', 'text', 'string', 'Folder with data:','fontweight','bold'} ...
          ...
          {'Style', 'checkbox', 'string' 'yes' 'value' RELAX_cfg.Do_MWF_Once 'tag' 'once' } ... % Input 1
          {'style', 'text', 'string', 'Blinks:'} ... 
          {'Style', 'checkbox', 'string' 'yes' 'value' RELAX_cfg.Do_MWF_Twice 'tag' 'twice' } ... % Input 2
          {'style', 'text', 'string', 'HEOG/drift:'} ... 
          {'Style', 'checkbox', 'string' 'yes' 'value' RELAX_cfg.Do_MWF_Thrice 'tag' 'thrice' } ... % Input 3; Line 2
          ...
          {'style', 'text', 'string', ''}...
          {}...
          {'style', 'text', 'string', 'Compute Artifact Metrics for Raw Data?'} ... 
          {'Style', 'checkbox', 'string' 'yes' 'value' RELAX_cfg.computerawmetrics 'tag' 'raw' } ... % Input 1
          {'style', 'text', 'string', ' '} ...
          {'style', 'text', 'string', 'Compute Artifact Metrics and Cleaning Metrics for Cleaned Data?'} ... 
          {'Style', 'checkbox', 'string' 'yes' 'value' RELAX_cfg.computecleanedmetrics 'tag' 'clean' } ... % Input 2
          {'style', 'text', 'string', ' '}
          };
