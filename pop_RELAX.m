...
% GUI layout
geometry = {[0.4 1.2 0.2 0.9 1.2 0.2] ... % setting directory / file to process
            1 ...
...
uilist = {{'style', 'text', 'string', 'Folder with data:','fontweight','bold','fontsize', 9} ...
          { 'style' 'edit'       'string' RELAX_cfg.myPath 'tag' 'datadir' ,'fontsize', 9} ... 
          { 'style' 'pushbutton' 'string' '...' 'callback' commandload1 ,'fontsize', 9}... 
          {'style', 'text', 'string', 'File to process (leave blank to process >1 file):','fontweight','bold','fontsize', 9} ...
          ...
          {'style', 'text', 'string', ' ','fontsize', 9} ...
          {'style', 'text', 'string', 'Delete electrode if it shows > proportion of extreme noise than:','fontsize', 9} ...
          {'style', 'edit', 'string', RELAX_cfg.ProportionOfExtremeNoiseAboveWhichToRejectChannel,'fontsize', 9}...
          {'style', 'text', 'string', ' ','fontsize', 9} ...
          {'style', 'text', 'string', 'Delete electrode if it shows > proportion of muscle than:','fontsize', 9} ...
