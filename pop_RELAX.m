...
geometry = {[3.5 5 1]...% title
            1 ...
            [0.55 1.3 0.2 0.6 1.8 0.2 0.75 1.5] ... % setting directory
            1 ...
            [5 .8 .5 2 0.5 3.5] ... % bandpass filter settings
            1 ...
            [1 0.2 0.2 1.2 0.2 0.2 1 0.2 0.6] ... % electrode rejection settings
            1 ...
            [1.8 0.7 0.3 1.1 0.3 0.7 0.3 0.7 0.3 0.5] ... % extreme period rejection settings
            1 ...
            [0.9 0.2 1.3 0.2 1.3 0.2 2]... % extreme period rejection settings MAD blinks and drift
            1 ...
            [0.6 0.2 0.6 0.4 0.4 0.4 0.6 0.4 0.4 0.7 0.9] ... %Wiener filter settings wICA settings and Blink probability options
            1 ...
            ...
            1 ...
            [2 0.3 1 3 0.5]... % horizontal eye movement marking for MWF
            1 ...
            [1.5 0.6 0.8 1 1.7 1 1 1]... % computing metrics? saving intermediate files?
            };
            
% GUI settings with defaults:        
uilist = {{'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'RELAX Cleaning Pipeline - Parameter Setting','fontweight','bold','fontsize', 12.5} ...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'Folder with data:','fontweight','bold','fontsize', 10} ...
          { 'style' 'edit'       'string' RELAX_cfg.myPath 'tag' 'datadir' ,'fontsize', 10} ... 
          { 'style' 'pushbutton' 'string' '...' 'callback' commandload1 ,'fontsize', 10}... 
          {'style', 'text', 'string', 'Cap Location File:','fontweight','bold','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.caploc 'tag' 'caploc' ,'fontsize', 10} ...
          { 'style' 'pushbutton' 'string' '...' 'callback' commandload2 ,'fontsize', 10}... 
          {'style', 'text', 'string', 'Electrodes to exclude:','fontweight','bold','fontsize', 10} ...
          {'style', 'edit', 'string', ''} ...
          {}...
          {'style', 'text', 'string', 'Bandpass Filter (Hz) [highpass, lowpass] (0.25Hz highpass is best for ERPs, 1Hz is better for cleaning artifacts):','fontsize', 10} ...
          {'style', 'edit', 'string', [num2str(RELAX_cfg.HighPassFilter), '  ', num2str(RELAX_cfg.LowPassFilter)],'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Line Noise Frequency (Hz) [eg. 50 or 60]:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.LineNoiseFrequency,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'Max Proportion of electrodes that can be deleted as bad:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.MaxProportionOfElectrodesThatCanBeDeleted,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Delete electrode if it shows > proportion of extreme noise than:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ProportionOfExtremeNoiseAboveWhichToRejectChannel,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Delete electrode if it shows > proportion of muscle than:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ProportionOfMuscleContaminatedEpochsAboveWhichToRejectChannel,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'Extreme outlier detection thresholds, applied to each 1s period:','fontweight','bold','fontsize', 10} ...
          {'style', 'text', 'string', 'Absolute voltage shift:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeAbsoluteVoltageThreshold,'fontsize', 10}...
          {'style', 'text', 'string', 'Improbable voltage value distributions (SD):','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeImprobableVoltageDistributionThreshold,'fontsize', 10}...
          {'style', 'text', 'string', 'Single channel kurtosis:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeSingleChannelKurtosisThreshold,'fontsize', 10}...
          {'style', 'text', 'string', 'All channel kurtosis:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeAllChannelKurtosisThreshold,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'MAD from median voltage shift:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeVoltageShiftThreshold,'fontsize', 10}...
          {'style', 'text', 'string', 'MAD from median voltage shift in blink affected epochs:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeBlinkShiftThreshold,'fontsize', 10}...
          {'style', 'text', 'string', 'Log-power log-frequency slope for detecting drift threshold:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ExtremeDriftSlopeThreshold,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {}...  
          {'style', 'text', 'string', 'MWF Delay Period:','fontweight','bold','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.MWFDelayPeriod,'fontsize', 10}...
          {'style', 'text', 'string', 'Use MWF to clean:','fontweight','bold','fontsize', 10} ... 
          {'Style', 'checkbox', 'string' 'Muscle' 'value' RELAX_cfg.Do_MWF_Once 'tag' 'once' ,'fontsize', 10} ... % Input 1
          {'Style', 'checkbox', 'string' 'Blinks' 'value' RELAX_cfg.Do_MWF_Twice 'tag' 'twice' ,'fontsize', 10} ... % Input 2
          {'Style', 'checkbox', 'string' 'HEOG/drift' 'value' RELAX_cfg.Do_MWF_Thrice 'tag' 'thrice' ,'fontsize', 10} ... % Input 3; Line 2
          {'Style', 'checkbox', 'string' 'Clean with wICA' 'value' RELAX_cfg.Perform_wICA_on_ICLabel 'tag' 'wICA' ,'fontsize', 10,'fontweight','bold'} ... % Input 1
          {'style', 'text', 'string', 'ICA method:','fontsize', 10} ...
          {'style', 'popupmenu', 'string', icaOptions, 'tag', 'icaOpts','Value',3,'fontsize', 10} ...
          {'style', 'text', 'string', 'Does the data contain blinks?','fontweight','bold','fontsize', 10} ...
          {'style', 'popupmenu', 'string', ProbabilityOfBlinksOptions, 'tag', 'blinkOpts','Value',1,'fontsize', 10} ...
          {} ...
          {'style', 'text', 'string', 'Electrodes affected by eye movements / blinks (for marking artifacts to be cleaned with MWF, list HEOG electrodes in order of use preference):','fontweight','bold','fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'Blink affected electrodes:','fontsize', 10} ...
          ...
          ' ' RELAX_cfg.BlinkElectrodes{7,1} ' ' RELAX_cfg.BlinkElectrodes{8,1} ' ' RELAX_cfg.BlinkElectrodes{9,1} ' ' RELAX_cfg.BlinkElectrodes{10,1}],'fontsize', 10} ...
          {'style', 'text', 'string', 'Left sided HEOG affected electrodes:','fontsize', 10} ...
          ...
          ' ' RELAX_cfg.HEOGLeftpattern{1,7} ' ' RELAX_cfg.HEOGLeftpattern{1,8} ' ' RELAX_cfg.HEOGLeftpattern{1,9}],'fontsize', 10} ...
          {'style', 'text', 'string', 'Right sided HEOG affected electrodes:','fontsize', 10} ...
          ...
          ' ' RELAX_cfg.HEOGRightpattern{1,7} ' ' RELAX_cfg.HEOGRightpattern{1,8} ' ' RELAX_cfg.HEOGRightpattern{1,9}],'fontsize', 10} ...
          {}...
          {'style', 'text', 'string', 'Log-frequency Log-power slope muscle artifact threshold for MWF cleaning:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.MuscleSlopeThreshold,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Max proportion marked as muscle for MWF cleaning (only most severe data up to max is marked if data exceeds threshold):','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.MaxProportionOfDataCanBeMarkedAsMuscle,'fontsize', 10}...
          {}...
          {'style', 'text', 'string', 'Single electrode voltage MAD from median of all electrodes to mark as drift for MWF cleaning:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.DriftSeverityThreshold,'fontsize', 10}...
          {'style', 'text', 'string', ' ','fontsize', 10} ...
          {'style', 'text', 'string', 'Max proportion marked as drift for MWF cleaning (only most severe data up to max is marked if data exceeds threshold):','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.ProportionWorstEpochsForDrift,'fontsize', 10}...
          {}...
          {'style', 'text', 'string', 'Horizontal eye movement threshold (MAD from median) for MWF cleaning:','fontsize', 10} ...
          {'style', 'edit', 'string', RELAX_cfg.HorizontalEyeMovementThreshold,'fontsize', 10}...
          {'style', 'text', 'string', '','fontsize', 10}...
          {'style', 'text', 'string', 'File numbers to process this session (from [start file number] to [finish file number] and all files in between):','fontsize', 10} ...
          {'style', 'edit', 'string', ['1', '  ', '2'],'fontsize', 10}...
          {}...
          {'style', 'text', 'string', 'Compute Artifact/Cleaning Metrics?','fontweight','bold','fontsize', 10} ... 
          {'Style', 'checkbox', 'string' 'For raw data' 'value' RELAX_cfg.computerawmetrics 'tag' 'raw' ,'fontsize', 10} ... % Input 1
          {'Style', 'checkbox', 'string' 'For cleaned data' 'value' RELAX_cfg.computecleanedmetrics 'tag' 'clean' ,'fontsize', 10} ... % Input 2
          {'style', 'text', 'string', 'Save Intermediate Steps?','fontweight','bold','fontsize', 10} ... 
          {'Style', 'checkbox', 'string' 'After electrode rejection/extreme period marking' 'value' RELAX_cfg.saveextremesrejected 'tag' 'saveextremesrejected' ,'fontsize', 10} ... % Input 1
          {'Style', 'checkbox', 'string' 'After 1st MWF cleaning' 'value' RELAX_cfg.saveround1 'tag' 'MWF1' ,'fontsize', 10} ... % Input 2
          {'Style', 'checkbox', 'string' 'After 2nd MWF cleaning' 'value' RELAX_cfg.saveround2 'tag' 'MWF2' ,'fontsize', 10} ... % Input 2
          {'Style', 'checkbox', 'string' 'After 3rd MWF cleaning' 'value' RELAX_cfg.saveround3 'tag' 'MWF3' ,'fontsize', 10} ... % Input 2
          };

result = inputgui('geometry', geometry, 'geomvert', [1 .4 1 .4 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1 0.5 1],  'uilist', uilist, 'title', 'RELAX Parameter Setting',  'helpcom', 'pophelp(''pop_RELAX'')');

% Replace default values with inputs
RELAX_cfg.myPath = result{1};
RELAX_cfg.caploc = result{2};
RELAX_cfg.ElectrodesToDelete = strtrim(strsplit(strrep(result{3},',','')))';
BandPassFilterSettings=strsplit(strrep(result{4},',',''));
...
RELAX_cfg.MaxProportionOfElectrodesThatCanBeDeleted=str2double(result{6});
RELAX_cfg.ProportionOfExtremeNoiseAboveWhichToRejectChannel=str2double(result{7});
RELAX_cfg.ProportionOfMuscleContaminatedEpochsAboveWhichToRejectChannel=str2double(result{8});
RELAX_cfg.ExtremeAbsoluteVoltageThreshold=str2double(result{9});
RELAX_cfg.ExtremeImprobableVoltageDistributionThreshold=str2double(result{10});
RELAX_cfg.ExtremeSingleChannelKurtosisThreshold=str2double(result{11});
RELAX_cfg.ExtremeAllChannelKurtosisThreshold=str2double(result{12});
RELAX_cfg.ExtremeVoltageShiftThreshold=str2double(result{13});
RELAX_cfg.ExtremeBlinkShiftThreshold=str2double(result{14});
RELAX_cfg.ExtremeDriftSlopeThreshold=str2double(result{15});
RELAX_cfg.MWFDelayPeriod=str2double(result{16});
RELAX_cfg.Do_MWF_Once=result{17}; % 1 = Perform the MWF cleaning a second time (1 for yes, 0 for no).
RELAX_cfg.Do_MWF_Twice=result{18}; % 1 = Perform the MWF cleaning a second time (1 for yes, 0 for no).
RELAX_cfg.Do_MWF_Thrice=result{19};
RELAX_cfg.Perform_wICA_on_ICLabel=result{20};
RELAX_cfg.ICA_method = icaOptions{result{21}};
RELAX_cfg.ProbabilityDataHasNoBlinks=(result{22})-1;
RELAX_cfg.BlinkElectrodes= strtrim(strsplit(strrep(result{23},',','')))';
RELAX_cfg.HEOGLeftpattern = string(strtrim(strsplit(strrep(result{24},',',''))));
RELAX_cfg.HEOGRightpattern= string(strtrim(strsplit(strrep(result{25},',',''))));
RELAX_cfg.MuscleSlopeThreshold=str2double(result{26});
RELAX_cfg.MaxProportionOfDataCanBeMarkedAsMuscle=str2double(result{27});
RELAX_cfg.DriftSeverityThreshold=str2double(result{28});
RELAX_cfg.ProportionWorstEpochsForDrift=str2double(result{29});
RELAX_cfg.HorizontalEyeMovementThreshold=str2double(result{30});
FilesToProcess=strsplit(strrep(result{31},',',''));
RELAX_cfg.FilesToProcess=str2double(FilesToProcess(1,1)):str2double(FilesToProcess(1,2));
RELAX_cfg.computerawmetrics=result{32};
RELAX_cfg.computecleanedmetrics=result{33};
RELAX_cfg.saveextremesrejected=result{34};
RELAX_cfg.saveround1=result{35};
RELAX_cfg.saveround2=result{36};
RELAX_cfg.saveround3=result{37};
