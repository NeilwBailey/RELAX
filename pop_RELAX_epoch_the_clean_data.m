...
uilist = {{'style', 'text', 'string', 'Cleaned data folder:','fontweight','bold','fontsize', 9} ...
          ...
          {'style', 'text', 'string', 'If resting data, how long between inserted triggers?','fontsize', 9} ...
          ...
          {'style', 'text', 'string', 'Period to epoch:','fontsize', 9} ...
          ...
          {'style', 'text', 'string', 'Baseline Correction Window:','fontsize', 9} ...
          ...
          {'style', 'popupmenu', 'string', YesNoOptions, 'tag', 'RejectMuscleOpts','Value',1,'fontsize', 9} ...
          {}...
